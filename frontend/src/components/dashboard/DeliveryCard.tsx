import type { DeliveryLog } from '@/types/dashboard';

interface Props {
    isLoading: boolean;
    activity: Record<string, DeliveryLog[]>;
}

export default function DeliveryCard({ isLoading, activity }: Props) {
